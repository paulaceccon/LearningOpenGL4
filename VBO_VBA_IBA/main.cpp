...
int main(void)
{
	...
	quadShader.SetVertexShader("SimpleVertexShader.txt");
	quadShader.SetFragmentShader("SimpleFragShader.txt");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm_ModelViewMatrix.push(glm_ModelViewMatrix.top());
		{
			...
			glm_ModelViewMatrix.push(glm_ModelViewMatrix.top());
			{
				quadShader.DrawModel(Projection, glm_ModelViewMatrix.top());
			}
